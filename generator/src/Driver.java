...
public class Driver {
    public static void main () throws IOException {
        ...
        URL path = Driver.class.getResource("res/allClues.txt");
        FileReader file =  new FileReader("res/allClues.txt");
        ...
        file =  new FileReader("res/mobyThes.txt");
        ...
        path = Driver.class.getResource("res/dict.txt");
        file =  new FileReader("res/dict.txt");
        buffer = new BufferedReader(file);
        int tempLen=0;
        char[] temp;
        ...
        file =  new FileReader("res/dictAndDef.txt");
        buffer = new BufferedReader(file);
        boolean foundDef;
        String definition;
        boolean empty;
